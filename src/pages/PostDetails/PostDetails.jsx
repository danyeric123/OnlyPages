            ...
            <article id="article">
              ...
              {post.categories.map((cat) => {
                return (
                  ...
                  >
                    <small className="text-blue-500">{cat}</small>
                  </Link>
                );
              })}
              <br />
              ...
              {post.author._id === userProfile._id && (
                <Link to={{ pathname: "/edit", state: post }}>
                  <button className="group my-3 relative flex justify-center py-2 px-4 border border-transparent text-sm font-medium rounded-md text-white bg-yellow-400 hover:bg-yellow-300">
                    Edit post
                  </button>
                </Link>
              )}
            ...
            <div class="replies">
              ...
              <ReplyForm addReply={addReply} />
              {
                <h2 className="font-bold">
                  {post.replies > 0 ? "Replies:" : "No Replies Yet"}
                </h2>
              }
