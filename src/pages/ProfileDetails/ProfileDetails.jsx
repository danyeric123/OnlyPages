...
const ProfileDetails = ({ userProfile }) => {
  ...
  return (
    ...
    userProfile && (
      <>
        <h1 className="font-bold text-black-500 text-3xl text-center mx-4 py-4 bg-gray-300 my-2">
        ...
        <h3 className="mx-4 font-bold text-black-500 text-3xl text-center py-4 bg-gray-300 my-2">
          Friends List
        </h3>
          ...
          {profile.friends.map((friend) => (
            <div className="md:p-8 p-2 h-90 border-transparent bg-blue-100 shadow-xl mx-2 my-2 w-full ">
              ...
              >
                ...
                <section className="font-bold text-black-500 text-xl text-center">
                  {friend.name}
                </section>
              </Link>
            </div>
