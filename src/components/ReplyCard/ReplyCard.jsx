...
const ReplyCard = ({reply,deleteReply,userProfile}) => {
  ...
  return (
    <div
      className="p-4 my-4 grid justify-center rounded-2xl shadow-2xl hover:shadow-none bg-gray-300 bg-opacity-40"
    >
      <h3
      ...
      >
        ...
        />:
          <FaUserCircle size={30} className="flex ml-3 justify-center object-contain" />
        }
      </h3>
      <p>{reply.content}</p>
