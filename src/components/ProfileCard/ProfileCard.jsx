...
const ProfileCard = ({ profile, userProfile, handleFriend }) => {
  return (
    <>
      ...
      <div className="md:p-8 p-2 flex-col border-transparent bg-blue-100 shadow-lg mx-2 my-2 w-full">
        <Link
          to={{
        ...
        >
          {profile.avatar ? (
            <img
              ...
              className="rounded-full ml-12 py-3 px-4 h-40 w-40"
            />
          ) : (
            ...
            <FaUserCircle
              size={100}
              style={{ color: "blue" }}
              className="px-2 py-3 flex item-center card__media w-screen md:w-full"
            />
          )}
        </Link>
        <section className="p-2 py-3 px-4 w-full ">
