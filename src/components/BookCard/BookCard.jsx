  ...
  return (
    <div className="md:p-8 p-2 h-90 border-transparent bg-blue-100 shadow-xl mx-2 my-2 w-full ">
      ...
      <section className="p-1 text-black-500 text-center">
        ...
        <p className="p-2">
          {book.subtitle && <p className="p-2">Subtitle: {book.subtitle}</p>}
        </p>
        <p className="p-1">
        ...
        {/* {book.description} */}
        <p className="p-2 my-2 object-contain overflow-auto h-48 border border-black-600">
          Description: {book.description ? book.description : "N/A"}
        </p>
        <Link to={`/books/${id}`}>
          <button className="group relative w-full flex justify-center py-1 border border-transparent text-sm font-medium rounded-md text-white bg-blue-700 hover:bg-blue-500 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-blue-500">
            READ MORE
          </button>
        </Link>
      </section>
